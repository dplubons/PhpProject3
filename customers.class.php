...
class Customer { 
	...
	private function generate_form_group ($label, $labelError, $val, $modifier="", $fieldType="") {
    ...
    function list_records() {
        ...
        echo "
            ...
            <body>
                <a href='https://github.com/dplubons/PhpProject3' target='_blank'>Github Repo</a><br />
                <a href='https://csis.svsu.edu/~dplubons/cis355/PhpProject3/CIS_355_UML.pdf' target='_blank'>Diagram</a><br />
                <a href='https://csis.svsu.edu/~dplubons/cis355/PhpProject3/CIS355_FlowChart3.pdf' target='_blank'>FlowChart</a><br />
